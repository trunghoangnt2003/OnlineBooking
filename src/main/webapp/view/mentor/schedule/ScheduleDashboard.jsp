...
<div class="body">
    ...
    <div class="right-side">
        <h1 style="color: rgb(43, 57, 64)" class="text-center">Time Table <%--<i class="fa-solid fa-circle-info fa-2xs"
                                                                     id="myBtn2"></i>--%></h1>
                        ...
                        <td>
                            ...
                            <c:choose>
                                <c:when test="${countCheck == 1 }">
                                    <div  id="button-schedule-td1" class="info-link"
                                          data-book-id="${week.dayOfMonth}_${t.id}"
                                          data-today-id="${week.dayOfMonth}"
                                          style="background: transparent; cursor: pointer" onclick="informationMentee()">
                                  ...
                                  <%--  <div class="notes-container">
                                        ...
                                        <blockquote class="notes red">
                                          ...
                                          &lt;%&ndash;  <button id="button-schedule-td1" class="info-link"
                                                    data-book-id="${week.dayOfMonth}_${t.id}"
                                                    data-today-id="${week.dayOfMonth}"
                                                    style="background: transparent" onclick="informationMentee()">
                                                    &lt;%&ndash;                                                    ${nameSkill}&ndash;%&gt;
                                                    ${nameType}
                                            </button>&ndash;%&gt;
                                            <c:if test="${present.equals('present') && icon}">
