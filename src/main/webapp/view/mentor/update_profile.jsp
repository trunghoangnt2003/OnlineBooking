...
<div class="container">
    ...
    <h2 style="color:#00B074;">Update Information</h2>
            ...
            <div class="row">
                ...
                <c:forEach items="${requestScope.levels}" var="level">
                    <div class="col-md-4 mb-4">
                        <!-- Summary & Details for each level -->
                        <details>
                            <!-- Summary for the level name -->
                            <summary style="font-size: 1.2em; font-weight: bold; color: #00B074; margin-bottom: 10px;">
                                    ${level.name} (Click to expand)
                            </summary>
                                ...
                                <c:forEach items="${requestScope.level_skills}" var="levelSkill">
                                    <c:if test="${levelSkill.level.name == level.name}">
                                        <div class="form-check" style="margin-bottom: 8px;">
                                            ...
                                            />
                                            <!-- Skill Label -->
                                            <label class="form-check-label" for="skill-${levelSkill.id}" style="font-size: 1em; color: #333;">
                                                    ${levelSkill.skill.name}
                                            </label>
                                        </div>
                                    </c:if>
                                </c:forEach>
